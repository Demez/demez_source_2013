...
// This sets what percentage of players are required in the changelevel trigger before map change takes effect. Currently it's set to 66% (all players required).
